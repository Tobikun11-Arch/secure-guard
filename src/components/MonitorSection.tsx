        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-blue-100 mb-8 leading-relaxed">
              Stay connected to your security system anywhere, anytime. Our
              mobile app gives you real-time access to your CCTV feeds, alerts,
              and security status right from your smartphone.
            </p>
