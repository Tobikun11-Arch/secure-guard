        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              ...
              provide comprehensive security solutions tailored to your specific
              needs. Our team of professionals is dedicated to ensuring the
              safety and protection of your property, assets, and people.
            </p>
