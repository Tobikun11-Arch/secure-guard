      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-blue-900 text-white p-12 rounded-2xl relative">
            ...
            <div className="mb-6">
              <h3 className="text-white mb-4">Nothing Secures you Better Than Us</h3>
              <p className="text-blue-100 leading-relaxed mb-6">
                "The team at SecureGuard has been exceptional. Their professional approach and 
                cutting-edge technology have given us complete peace of mind. The 24/7 monitoring 
                service is worth every penny. Highly recommended!"
              </p>
