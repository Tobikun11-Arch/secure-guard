...
export function Hero() {
  return (
    <section id="home" className="bg-gradient-to-br from-slate-50 to-blue-50 py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Protecting what matters most with cutting-edge technology and experienced professionals. 
